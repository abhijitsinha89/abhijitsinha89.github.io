...
!function(i,a,r){"use strict";function e(){function i(i,a,e){return function(t,n,c){var u=c.$normalize(a);r[u]&&!c[u]&&t.$watch(c[i],function(i){e&&(i=!i),n.attr(a,i)})}}var r={ariaHidden:!0,ariaChecked:!0,ariaDisabled:!0,ariaRequired:!0,ariaInvalid:!0,ariaMultiline:!0,ariaValue:!0,tabindex:!0,bindKeypress:!0};this.config=function(i){r=a.extend(r,i)},this.$get=function(){return{config:function(i){return r[i]},$$watchExpr:i}}}var t=a.module("ngAria",["ng"]).provider("$aria",e);t.directive("ngShow",["$aria",function(i){return i.$$watchExpr("ngShow","aria-hidden",!0)}]).directive("ngHide",["$aria",function(i){return i.$$watchExpr("ngHide","aria-hidden",!1)}]).directive("ngModel",["$aria",function(i){function a(a,r,e){return i.config(r)&&!e.attr(a)}function r(i,a){return!a.attr("role")&&a.attr("type")===i&&"INPUT"!==a[0].nodeName}function e(i,a){var r=i.type,e=i.role;return"checkbox"===(r||e)||"menuitemcheckbox"===e?"checkbox":"radio"===(r||e)||"menuitemradio"===e?"radio":"range"===r||"progressbar"===e||"slider"===e?"range":"textbox"===(r||e)||"TEXTAREA"===a[0].nodeName?"multiline":""}return{restrict:"A",require:"?ngModel",priority:200,compile:function(t,n){var c=e(n,t);return{pre:function(i,a,r,e){"checkbox"===c&&"checkbox"!==r.type&&(e.$isEmpty=function(i){return i===!1})},post:function(e,t,n,u){function o(){return u.$modelValue}function d(){return f?(f=!1,function(i){var a=n.value==u.$viewValue;t.attr("aria-checked",a),t.attr("tabindex",0-!a)}):function(i){t.attr("aria-checked",n.value==u.$viewValue)}}function l(){t.attr("aria-checked",!u.$isEmpty(u.$viewValue))}var f=a("tabindex","tabindex",t);switch(c){case"radio":case"checkbox":r(c,t)&&t.attr("role",c),a("aria-checked","ariaChecked",t)&&e.$watch(o,"radio"===c?d():l);break;case"range":r(c,t)&&t.attr("role","slider"),i.config("ariaValue")&&(n.min&&!t.attr("aria-valuemin")&&t.attr("aria-valuemin",n.min),n.max&&!t.attr("aria-valuemax")&&t.attr("aria-valuemax",n.max),t.attr("aria-valuenow")||e.$watch(o,function(i){t.attr("aria-valuenow",i)}));break;case"multiline":a("aria-multiline","ariaMultiline",t)&&t.attr("aria-multiline",!0)}f&&t.attr("tabindex",0),u.$validators.required&&a("aria-required","ariaRequired",t)&&e.$watch(function(){return u.$error.required},function(i){t.attr("aria-required",!!i)}),a("aria-invalid","ariaInvalid",t)&&e.$watch(function(){return u.$invalid},function(i){t.attr("aria-invalid",!!i)})}}}}}]).directive("ngDisabled",["$aria",function(i){return i.$$watchExpr("ngDisabled","aria-disabled")}]).directive("ngMessages",function(){return{restrict:"A",require:"?ngMessages",link:function(i,a,r,e){a.attr("aria-live")||a.attr("aria-live","assertive")}}}).directive("ngClick",["$aria","$parse",function(i,a){return{restrict:"A",compile:function(r,e){var t=a(e.ngClick,null,!0);return function(a,r,e){function n(i,a){return-1!==a.indexOf(i[0].nodeName)?!0:void 0}var c=["BUTTON","A","INPUT","TEXTAREA"];r.attr("role")||n(r,c)||r.attr("role","button"),i.config("tabindex")&&!r.attr("tabindex")&&r.attr("tabindex",0),!i.config("bindKeypress")||e.ngKeypress||n(r,c)||r.on("keypress",function(i){function r(){t(a,{$event:i})}(32===i.keyCode||13===i.keyCode)&&a.$apply(r)})}}}}]).directive("ngDblclick",["$aria",function(i){return function(a,r,e){i.config("tabindex")&&!r.attr("tabindex")&&r.attr("tabindex",0)}}])}(window,window.angular);
